    ...
    return (
        <div>
            ...
            <div className="mt-12">
                ...
                <p className="text-2xl font-heading text-center font-heading text-slate-500">NOW YOU CAN SEE, EDIT OR DELETE PRODUCT</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 my-20 mx-10 md:mx-20">
                {
                    phonesData.slice(0, visible).map(item => (
                        <div key={item.id} >
